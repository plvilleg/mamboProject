...
void COMPASS::setup_Compass(){
	...
	compass.setRange(HMC5843_RANGE_1_3GA);
	
	compass.setOperatingMode(HMC5843_NORMAL_MODE);

	compass.setMeasurementMode(HMC5843_CONTINUOS);

	compass.setDataRate(HMC5843_DATARATE_30HZ);

	compass.setSamples(HMC5843_SAMPLES_8);
